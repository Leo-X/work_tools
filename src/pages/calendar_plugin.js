var ctrip = (function(window) {
    ...
    ctrip.fn = ctrip.prototype = {
        constructor: ctrip,
        init: function(data) {},
        createDom: function(domId, isIE, boxNum) {
            ...
            var styleStr =
                ...
                ".d-calendar .d-calendar-box{position: relative;display:inline-block;*zoom:1;*display: inline; width: 280px;vertical-align: top;}" +
                ...
                ".d-c-week .d-week-item{position: relative;float: left; display:inline-block;*zoom:1;*display: inline;width: 40px;height: 40px;line-height: 40px;text-align: center; overflow: hidden;font-size:14px; z-index:2;}" +
                ".d-c-day .d-day-item{position: relative;float: left; display:inline-block;*zoom:1;*display: inline;width: 40px;height: 40px; line-height: 40px;text-align: center; font-size: 14px; overflow: hidden;cursor: pointer;}" +
