    ...
    ctrip.fn = ctrip.prototype = {
        ...
        createDom: function(domId, isIE, boxNum, styleID) {
            ...
            var styleCont =
                ...
                styleStr +
                ' .d-calendar{display: block;z-index: 2; padding: 20px 10px 0 10px;width: 530px;overflow: auto; background-color: #fff;box-shadow:0 2px 8px 0 rgba(0,0,0,0.2);font-family:"Microsoft YaHei","微软雅黑",arial,simhei;color: #333;outline: none;' +
                "}" +
                styleStr +
        ...
        calendar2: function(setting) {
            ...
            function initials() {
                ...
                _this.calendarBox.style.top = _this.datePicker[0].getBoundingClientRect().bottom + 5 + "px";
            ...
            function showPop(e) {
                stopPropagation(e);
                if (_this.datePicker[0].getAttribute("data-date1") && _this.datePicker.length === 2) {
                    _this.clickDate[0] = _this.datePicker[0].getAttribute("data-date1");
                    _this.clickDate[1] = _this.datePicker[1].getAttribute("data-date2");
                }
            ...
            function hidePop(e) {
                ...
                _this.calendarPop.parentNode.removeChild(_this.calendarPop);
            }
